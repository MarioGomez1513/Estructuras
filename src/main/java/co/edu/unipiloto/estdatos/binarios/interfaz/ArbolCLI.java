    ...
    public void recibirArchivo() {
        ...
        while (!finish) {
            ...
            try {
                ...
                IReconstructorArbol reconstructor = new ReconstructorArbol();
                reconstructor.cargarArchivo(in.next());
                reconstructor.reconstruir();
                reconstructor.imprimirArbolEnJSON();
                reconstructor.crearArchivo();
